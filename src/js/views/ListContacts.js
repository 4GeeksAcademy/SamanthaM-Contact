    ...
    return (
        <div className="contact-slot">
            <ul>
                ...
                <li className="address-contact-row"> <i class="fa-solid fa-location-dot"></i> {props.address}</li>
                <li className="phone-contact-row"><i class="fa-solid fa-phone"></i>{props.phone}</li>
                <li className="email-contact-row"><i class="fa-solid fa-phone"></i>{props.email}</li>
